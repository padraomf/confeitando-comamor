...
export async function advanceOrder(id:string,status:string,actor:string,pickupCode?:string){
 ...
 if(!payOnDelivery(o)&&o.payment_status!=='Pago'&&!(o.data.depositRequired&&receivedAmount(o)>=o.data.depositRequired))throw new HttpError(422,'Aguarde a confirmação do pagamento antes de continuar.');
